...
const Socials = ({isAdaptive}) => {
    return (
        <div className={`${styles.socials} ${handleStyle(isAdaptive)}`}>
            ...
            <a href='https://api.whatsapp.com/send?phone=79107647349' target='_blank'><img className={styles.img} src='/images/whatsapp.png'/></a>
            <a href='https://t.me/plus_friend' target='_blank'><img className={styles.img} src='/images/telegram.png'/></a>
        </div>
    )
}
