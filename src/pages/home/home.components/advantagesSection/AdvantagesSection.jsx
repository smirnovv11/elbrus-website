        ...
        <div className={styles.content_container}>
            <ul className={styles.list}>
                ...
                <li className={styles.item}>
                    ...
                    <p>"Эльбрус" всегда остается на передовой технологических инноваций в области охранной деятельности. Мы интегрируем передовые системы видеонаблюдения, датчиков движения и контроля доступа, что позволяет нам реагировать быстро и эффективно на любые события. Наша оперативность и способность быстро адаптироваться к изменяющимся условиям позволяют нам быть впереди потенциальных угроз.</p>
                </li>
                <li className={styles.item}>
                ...
                <li className={styles.item}>
                    <h2>Круглосуточная поддержка и оперативная реакция</h2>
                    <p>"Эльбрус" предоставляет клиентам не только надежную защиту, но и круглосуточную поддержку. Наша оперативная реакция на любые ситуации и готовность выйти на помощь в любое время суток позволяют клиентам чувствовать себя защищенными и уверенными в нашей поддержке.</p>
                </li>
                <li className={styles.item}>
